...
namespace HookrTelegramBot.Migrations
{
    ...
    [Migration("20201026221228_ExplicitForeignKeyForWebAppUsers")]
    partial class ExplicitForeignKeyForWebAppUsers
    {
            ...
            modelBuilder.Entity("Hookr.Core.Repository.Context.Entities.Base.TelegramBotUser", b =>
                {
                    ...
                    b.HasIndex("WebAppUserId")
                        .IsUnique()
                        .HasFilter("[WebAppUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("Hookr.Core.Repository.Context.Entities.Base.TelegramBotUser", b =>
                {
                    b.HasOne("Hookr.Core.Repository.Context.Entities.TelegramWebAppUser", "WebAppUser")
                        .WithOne("BotUser")
                        .HasForeignKey("Hookr.Core.Repository.Context.Entities.Base.TelegramBotUser", "WebAppUserId")
